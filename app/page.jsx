      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative px-6 py-16 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-2xl md:text-3xl text-gray-700 font-light mb-2">Food Distribution Portal</p>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="group relative bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
              ...
              <div className="p-8">
                <div className="flex items-center mb-6">
                  ...
                  <h2 className="text-2xl font-bold text-gray-800">Branch Representatives</h2>
                </div>
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Manage pending and delivered orders for your delivery branch. Access order processing and delivery coordination tools.
                </p>
                <Link href="/rep/login" className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-green-500 to-green-600 text-white font-semibold rounded-xl hover:from-green-600 hover:to-green-700 transition-all duration-200 shadow-lg hover:shadow-xl">
            ...
            <div className="group relative bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
              ...
              <div className="p-8">
                ...
                <Link href="/admin/pin" className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-purple-500 to-purple-600 text-white font-semibold rounded-xl hover:from-purple-600 hover:to-purple-700 transition-all duration-200 shadow-lg hover:shadow-xl">
                  <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
