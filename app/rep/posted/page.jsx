...
function RepPostedPageContent() {
  ...
  return (
    <div className="p-3 sm:p-6 max-w-7xl mx-auto">
      <h1 className="text-xl sm:text-2xl font-semibold mb-4">Rep — Posted Orders</h1>
        ...
        {orders.map(o => (
          <div key={o.order_id} className="p-3 sm:p-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3 mb-3">
              ...
              <div className="text-sm sm:text-base">{new Date(o.posted_at || o.created_at).toLocaleString()}</div>
            ...
            <div className="flex justify-end mb-3">
              <button className="px-3 py-1 bg-emerald-600 text-white rounded text-sm whitespace-nowrap" onClick={() => deliverOne(o.order_id)}>Deliver</button>
            </div>
